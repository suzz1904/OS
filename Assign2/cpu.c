...
int main() {
    ...
    int timestamp = 0;
    struct PCB process1 = {1, 0, 10, 0, 0, 10, 1};  // Process 1, Priority 1
    struct PCB process2 = {2, 2, 5, 0, 0, 5, 2};   // Process 2, Priority 2
    struct PCB process3 = {3, 3, 7, 0, 0, 7, 0};   // Process 3, Priority 0 (highest priority)
